...
#TODO Import PYFPDF, create pdf from a template and from set data
...
elements = [
    ...
    { 'name': 'QR', 'type': 'I', 'x1': 30.0, 'y1': 30, 'x2': 60.0, 'y2': 60.0, 'font': 'Interleaved 2of5 NT', 'size': 0.75, 'bold': 0, 'italic': 0, 'underline': 0, 'foreground': 0, 'background': 0, 'align': 'I', 'text': '200000000001000159053338016581200810081', 'priority': 3, },
]
...
f["company_name"] = "Ridlees"
f["company_logo"] = "bill.png"
# QR 298 × 297
f["QR"] = "img.png"
